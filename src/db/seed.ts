...
async function main() {
  ...
  // Встречи — большие конспекты разговоров, привязанные к людям.
  await db.insert(meetings).values([
    {
      title: "Обсудили тему курсовой",
      date: today(-3),
      personId: supervisor.id,
      location: "Кафедра, ауд. 512",
      body: "<p>Иван Иванович одобрил направление — <strong>сходимость рядов Фурье</strong>.</p><h2>Что решили</h2><ul><li>К следующей встрече собрать список источников (мин. 5 статей).</li><li>Написать план из трёх глав.</li><li>Черновик введения — до конца месяца.</li></ul><blockquote>Просил не тянуть с практической частью — на ней всё держится.</blockquote>",
    },
    {
      title: "Кофе с Аней перед сессией",
      date: today(-2),
      personId: anya.id,
      location: "Кофейня «Бариста»",
      body: "<p>Поговорили про экзамены и немного про жизнь.</p><ul><li>Аня скинет свои конспекты по матанализу.</li><li>Договорились готовиться к экзамену вместе в субботу.</li><li>Позвать в группу ещё пару человек.</li></ul>",
    },
    {
      title: "Смена с Марком",
      date: today(-6),
      personId: mark.id,
      location: "Кофейня «Бариста»",
      body: "<p>Марк показал, как правильно настраивать помол и держать темп в час пик.</p><p>Обещал поставить меня на выходные — там больше чаевых.</p>",
    },
  ]);
