...
/** Живой поиск по встречам: печатаешь — URL обновляется (фильтр по человеку сохраняется). */
export function MeetingSearchBox({
  initialQ,
  person,
}: {
  initialQ: string;
  ...
  return (
    <div className="flex h-11 items-center gap-2 rounded-xl border border-border bg-surface px-3 focus-within:border-accent">
      ...
      <input
        ...
        placeholder="Искать по встречам…"
